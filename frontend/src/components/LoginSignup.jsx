...
const LoginSignup = ({setShowLoginSignup}) => {
  ...
  return (
    <div className='absolute z-10 w-full h-full -my-20 overflow-hidden bg-dark-coffee/80'>
       <div className='absolute top-14 xl:top-12 left-[10%] xs:left-[20%] sm:left-[25%] lg:left-[30%] xl:left-[30%] py-4 xl:py-8 px-10 animate-fade-in-quick bg-white border my-5 rounded-xl hover:shadow-xl lg:w-[35vw]'>
...

        {
          showForgotPassword ? (
            ...
            <form className='flex flex-col items-start w-60 lg:w-[35vw]' onSubmit={onSubmitHandler} >
              {
                  currState === "Sign In" ? <></> : <input type="text" placeholder="Name" className='border text-base mt-3 xl:my-4 py-2 px-4 outline-none rounded-xl lg:w-4/5 w-full'
                  name='name' onChange={onChangeHandler} value={data.name}
                  />
              }
              <input type="email" placeholder="Email" className='border text-base mt-3 xl:my-4 py-2 px-4 outline-none rounded-xl lg:w-4/5 w-full'
              name='email' onChange={onChangeHandler} value={data.email}
              />
              <div className='w-full lg:w-4/5 my-4 outline-none relative'>
              ...
              <button type="submit" className='w-full lg:w-4/5 bg-carrot/85 hover:bg-carrot text-white font-semibold text-xl py-2 rounded-xl'>
                {
